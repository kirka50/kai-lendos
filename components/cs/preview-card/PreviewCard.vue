...
<template>
  <UiCard class="rounded-2xl overflow-hidden shadow-sm flex flex-col justify-between">
    <UiCardHeader class="p-0 m-0 h-fit">
      <img :src="`./portfolio/${props.image}`" alt="1" class="object-cover h-36 md:h-64 lg:h-80" />
    </UiCardHeader>
